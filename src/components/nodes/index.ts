...
import BinOpNode, {type BinOpNode as BinOpNodeType } from "./BinOpNode.tsx";
...
export type CustomNodeType = InputNodeType | OutputNodeType | WaveGenNodeType | BinOpNodeType;